...
Seeing what the `step` function returned, let's compare it to a model that
solely includes the variables that seem to have the most significant impact on
satisfaction.
...
As we can see, although this model does perform slightly worse than the one
obtained through the stepwise method, it is much simpler and easier to interpret.
In the following section, we will do a more thorough comparison between the two.
